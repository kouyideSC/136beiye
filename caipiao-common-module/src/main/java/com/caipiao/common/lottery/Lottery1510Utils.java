 ...
 * @author  mcdog
 */
public class Lottery1510Utils extends LotteryUtils
{
    /**
     * 生成期次(一年期次)
     * @author  mcdog
    ...
    public List<Map<String,String>> createPeriodsOfYear(String lotteryCloseTime, Calendar calendar)
    {
        ...
        //获取本年第一期次开奖的详细时间
        Calendar firstKjCalendar = getLotteryFirstKjDateOfYear(LotteryConstants.QXC,calendar);
        ...
        for(int i = 0; i < dayOffset; i ++)
        {
                    ...
                    || firstKjCalendar.get(Calendar.DAY_OF_WEEK) == Calendar.SUNDAY)
            {
                ...
                if(!isCloseTime)
                {
                    ...
                    periodMap.put("lotteryId",LotteryConstants.QXC);
                    ...
                    periodMap.put("sellEndTime",DateUtil.formatDate(getLotterySellEndTime(LotteryConstants.QXC,firstKjCalendar).getTime(),DateUtil.DEFAULT_DATE_TIME));
    ...
    public static void main(String[] args)
    {
        try
        {
            String lotteryCloseTime = "2019-02-04 00:00:00~2019-02-10 24:00:00";
            Calendar calendar = Calendar.getInstance();
            calendar.set(Calendar.YEAR,2019);
            LotteryUtils lotteryUtils = new Lottery1510Utils();
            ...
            scheme.setLotteryId("1510");
            scheme.setSchemeContent("12,35,6789,7,58,3,8:1:2");
            scheme.setDrawNumber("1,3,4,5,6,7,9");
