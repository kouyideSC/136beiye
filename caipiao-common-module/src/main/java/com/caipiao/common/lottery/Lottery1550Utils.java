 ...
 * @author  mcdog
 */
public class Lottery1550Utils extends LotteryUtils
{
    /**
     * 一天最大期次数
     */
    ...
    public List<Map<String,String>> createPeriodsOfYear(String lotteryCloseTime, Calendar calendar)
    {
        ...
        lastYearLastKjCalendar.setTime(DateUtil.parseDate(
                (DateUtil.formatDate(lastYearLastKjCalendar.getTime(),DateUtil.DEFAULT_DATE) + " " + LotteryConstants.lotteryLatestKjTimeMaps.get(LotteryConstants.X511_GD)),
                DateUtil.DEFAULT_DATE_TIME));

        //获取一年中第一次开奖详细时间
        Calendar firstKjCalendar = getLotteryFirstKjDateOfYear(LotteryConstants.X511_GD,calendar);
        firstKjCalendar.setTime(DateUtil.parseDate(
                (DateUtil.formatDate(firstKjCalendar.getTime(),DateUtil.DEFAULT_DATE) + " " + LotteryConstants.lotteryEarliestKjTimeMaps.get(LotteryConstants.X511_GD)),
                DateUtil.DEFAULT_DATE_TIME));
        ...
        for(int i = 0; i < dayOffset; i ++)
        {
            ...
            if(!isCloseTime)
            {
                ...
                for(int j = 1; j <= maxPeriodOfDay; j ++)
                {
                    ...
                    periodMap.put("lotteryId",LotteryConstants.X511_GD);
                    ...
                    periodMap.put("sellEndTime",DateUtil.formatDate(getLotterySellEndTime(LotteryConstants.X511_GD,firstKjCalendar).getTime(),DateUtil.DEFAULT_DATE_TIME));
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            LotteryUtils lotteryUtils = new Lottery1550Utils();
            ...
            scheme.setSchemeContent("01|04|06,08:10:2");
            scheme.setDrawNumber("03,04,06,08,10");
            scheme.setSchemeType(0);
            scheme.setLotteryId("1550");
            Lottery1550Utils lotteryUtils = new Lottery1550Utils();
