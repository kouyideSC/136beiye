 ...
 * @author  mcdog
 */
public class Lottery1050Utils extends LotteryUtils
{
    /**
     * 一天最大期次数
     */
    public static final int maxPeriodOfDay = 87;
    /**
     * 每天最早开奖时间(小时)
     */
     ...
     * 每天最早开奖时间(分钟)
     */
    public static final int earliestKjMinute = 30;
    ...
    public List<Map<String,String>> createPeriodsOfYear(String lotteryCloseTime, Calendar calendar)
    {
        ...
        lastYearLastKjCalendar.setTime(DateUtil.parseDate(
                (DateUtil.formatDate(lastYearLastKjCalendar.getTime(),DateUtil.DEFAULT_DATE) + " " + LotteryConstants.lotteryLatestKjTimeMaps.get(LotteryConstants.K3_JL)),
                DateUtil.DEFAULT_DATE_TIME));

        //获取一年中第一次开奖详细时间
        Calendar firstKjCalendar = getLotteryFirstKjDateOfYear(LotteryConstants.K3_JL,calendar);
        firstKjCalendar.setTime(DateUtil.parseDate(
                (DateUtil.formatDate(firstKjCalendar.getTime(),DateUtil.DEFAULT_DATE) + " " + LotteryConstants.lotteryEarliestKjTimeMaps.get(LotteryConstants.K3_JL)),
                DateUtil.DEFAULT_DATE_TIME));
        ...
        for(int i = 0; i < dayOffset; i ++)
        {
            ...
            if(!isCloseTime)
            {
                ...
                for(int j = 1; j <= maxPeriodOfDay; j ++)
                {
                    ...
                    periodMap.put("lotteryId",LotteryConstants.K3_JL);
                    ...
                    periodMap.put("sellEndTime",DateUtil.formatDate(getLotterySellEndTime(LotteryConstants.K3_JL,firstKjCalendar).getTime(),DateUtil.DEFAULT_DATE_TIME));
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            LotteryUtils lotteryUtils = new Lottery1050Utils();
            ...
            scheme.setLotteryId("1050");
            scheme.setSchemeContent("1,2,3|4,5:7:2");
            scheme.setDrawNumber("2,3,4");
