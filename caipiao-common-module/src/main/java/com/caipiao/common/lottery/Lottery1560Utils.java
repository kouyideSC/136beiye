 ...
 * @author  mcdog
 */
public class Lottery1560Utils extends LotteryUtils
{
    /**
     * 一天最大期次数
     */
     ...
     * 每天最早开奖时间(分钟)
     */
    public static final int earliestKjMinute = 36;
    ...
    public List<Map<String,String>> createPeriodsOfYear(String lotteryCloseTime, Calendar calendar)
    {
        ...
        lastYearLastKjCalendar.setTime(DateUtil.parseDate(
                (DateUtil.formatDate(lastYearLastKjCalendar.getTime(),DateUtil.DEFAULT_DATE) + " " + LotteryConstants.lotteryLatestKjTimeMaps.get(LotteryConstants.X511_SD)),
                DateUtil.DEFAULT_DATE_TIME));

        //获取一年中第一次开奖详细时间
        Calendar firstKjCalendar = getLotteryFirstKjDateOfYear(LotteryConstants.X511_SD,calendar);
        firstKjCalendar.setTime(DateUtil.parseDate(
                (DateUtil.formatDate(firstKjCalendar.getTime(),DateUtil.DEFAULT_DATE) + " " + LotteryConstants.lotteryEarliestKjTimeMaps.get(LotteryConstants.X511_SD)),
                DateUtil.DEFAULT_DATE_TIME));
        ...
        for(int i = 0; i < dayOffset; i ++)
        {
            ...
            if(!isCloseTime)
            {
                ...
                for(int j = 1; j <= maxPeriodOfDay; j ++)
                {
                    ...
                    periodMap.put("lotteryId",LotteryConstants.X511_SD);
                    ...
                    periodMap.put("sellEndTime",DateUtil.formatDate(getLotterySellEndTime(LotteryConstants.X511_SD,firstKjCalendar).getTime(),DateUtil.DEFAULT_DATE_TIME));
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            LotteryUtils lotteryUtils = new Lottery1560Utils();
