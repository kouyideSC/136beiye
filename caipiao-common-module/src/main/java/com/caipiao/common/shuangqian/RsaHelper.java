...
public class RsaHelper
{
	 ...
	 */
	public static String signData(String toBeSigned, String priKey)
	{
	 ...
	 * @return 返回解密后的原始明文
	 */
	public static String decryptData(String encryptedData, String priKey)
	{
		try
		{
	 ...
	 * @throws IOException
	 */
	public static void getAutoCreateRSA() throws NoSuchAlgorithmException, IOException
	{
		try
		{
