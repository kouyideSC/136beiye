...
public class ScopeBonusUtil {
    ...
    public static void main(String[] args) {
        ...
        String[] s2 = new String[] {"SPF-1|5.40", "RQSPF-1|4.15|-1"};
        String[] s3 = new String[] {"SPF-1|4.00", "RQSPF-1|3.50|-1"};
        //String[] s4 = new String[] {"RQSPF-1|3.4"};
        list1.add(s2);
        list1.add(s3);
        //list1.add(s4);
        ...
        String[] s5 = new String[] {"SF-0|1.75","RFSF-3|1.87|-1.5"};
        String[] s6 = new String[] {"RFSF-3|1.75|-5.5","DXF-0|1.69"};
        list4.add(s5);
        list4.add(s6);
