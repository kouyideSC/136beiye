    ...
    public CodeInfo getCodeBean(SchemeTicket ticket, GamePluginAdapter plugin){
        ...
        try {
            ...
            if(gcc.getCastMoney() * ticket.getMultiple() != ticket.getMoney().intValue()) {//判断金额是否一致，防止票表被修改
                ...
                //HH|20181031005>RQSPF=1,20181031007>RQSPF=1,20181031009>RQSPF=1,20181031012>SPF=0,20181031013>RQSPF=1,20181031016>RQSPF=1|6*1
                ...
                for(int x = 0; x < matchs.length; x++) {
                    String[] m = PluginUtil.splitter(matchs[x], DY_SPLIT);//20181031005>RQSPF=1
                    String[] n = PluginUtil.splitter(m[0], DF_SPLIT);//20181031005>RQSPF
