...
public class SaleRechargeController extends BaseController
{
    private static final Logger logger = LoggerFactory.getLogger(SaleRechargeController.class);
    ...
    @ModuleAuthorityRequired(mcode = "menu_xiaoshou_userrecharge")
