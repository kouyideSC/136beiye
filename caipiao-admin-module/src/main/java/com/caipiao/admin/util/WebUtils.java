...
public class WebUtils
{
    ...
    public static BaseDto getPraramsAsDto(HttpServletRequest request) {
        ...
        dto.put("opaccountId", request.getAttribute("opaccountId"));
        dto.put("opaccountName", request.getAttribute("opaccountName"));
        dto.put("oppersonalName", request.getAttribute("oppersonalName"));
        dto.put("opfullName", request.getAttribute("opfullName"));
        dto.put("opdataSecurity", request.getAttribute("opdataSecurity"));
        return dto;
    }
    ...
    public static List getParamList(HttpServletRequest request) {
        ServletContext context = request.getSession().getServletContext();
        return (List) (SystemUtils.isEmpty(context) ? new ArrayList() : (List) context.getAttribute("EAPARAMLIST"));
    }
