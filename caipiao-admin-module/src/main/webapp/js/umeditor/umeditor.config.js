...
(function () {
     ...
     */
    var URL = window.umeditorHomeUrl || (function(){
    ...
    window.UMEDITOR_CONFIG =
    {
        ...
        //图片上传配置区
        ,imageUrl:window.umeditorImageUploadUrl || (URL+"jsp/imageUp.jsp")             //图片上传提交地址
        ,imagePath:window.umeditorImagePath || URL   //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
