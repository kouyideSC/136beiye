...
<%
    ...
    request.setAttribute("sidebar_mcode","menu_chupiao_change");
%>
<html lang="en" class="app">
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="EmulateIE9" >
    <title>切票管理-列表/票查询</title>
    ...
    <div class="whitebox">
        <div class="clearfix status-options operate" callback="querydatas(1);">
            <div class="clearfix">
                ...
                <button opauthority="btn_chupiao_change_qp" class="btn btn-info do-condition" id="changeTicket">批量切票</button>
            </div>
        </div>
...
$(function ()
{
    ...
    $('#confirmModalSureBtn').on('click',function()
    {
        ...
        $.ajax({
            url : '${pageContext.request.contextPath}/ticket/change/qiepiao',
            type : 'post',
            dataType : 'json',
