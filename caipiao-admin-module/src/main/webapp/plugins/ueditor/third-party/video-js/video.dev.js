...
vjs.Player.prototype.loadTech = function(techName, source){
  ...
  var techReady = function(){
    ...
    // Manually track progress in cases where the browser/flash player doesn't check it.
    if (!this.features['progressEvents']) {
      this.player_.manualProgressOn();
    }

    // Manually track timeudpates in cases where the browser/flash player doesn't check it.
...
vjs.SeekBar.prototype.getPercent = function(){
  var currentTime;
  // Flash RTMP provider will not check the correct time
...
vjs.MediaTechController.prototype.addControlsListeners = function(){
  ...
  // check activity on the other events, but won't let them bubble for
