...
public class JsonHelper {
    ...
    public static final String encodeObject2Json(Object pObject) {
        String jsonString = "[]";
        if (pObject == null || "".equals(pObject)) {
    ...
    public static final String encodeObject2Json(Object pObject, String pFormatString) {
        ...
        if (pObject == null || "".equals(pObject)) {
            ...
            cfg.registerJsonValueProcessor(Float.class, new JsonValueProcessorImpl(pFormatString));
            if (pObject instanceof ArrayList) {
    ...
    public static String encodeDto2FormLoadJson(Dto pDto, String pFormatString) {
        ...
        jsonString = "{success:"
                + (StringUtils.isEmpty(pDto.getAsString("success")) ? "true" : pDto.getAsString("success")) + ",data:"
                + sunJsonString + "}";
        /*if (log.isInfoEnabled()) {
            log.info("序列化后的JSON资料输出:\n" + jsonString);
        }*/
    ...
    public static String encodeDto2FormLoadJson(Object pObject, String pFormatString) {
        String jsonString = "";
        String sunJsonString = "";
        if (StringUtils.isEmpty(pFormatString)) {
        ...
        jsonString = "{success:true,data:" + sunJsonString + "}";
        /*if (log.isInfoEnabled()) {
            log.info("序列化后的JSON资料输出:\n" + jsonString);
        }*/
        return jsonString;
     ...
     *
     * @param jsonString 复杂Json对象,格式必须符合如下契约<br>
     *                   {"1":{"name":"托尼.贾","age":"27"},
     *                   "2":{"name":"甄子丹","age":"72"}}
     * @return List
     */
